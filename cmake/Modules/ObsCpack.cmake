...
if(NOT DEFINED OBS_VERSION_OVERRIDE)
	if(EXISTS "${CMAKE_SOURCE_DIR}/.git")
		execute_process(COMMAND git tag --sort=-taggerdate
			COMMAND head -1
		...
		execute_process(COMMAND git describe --always --tags
			...
			WORKING_DIRECTORY "${CMAKE_SOURCE_DIR}"
			OUTPUT_STRIP_TRAILING_WHITESPACE)
		file(WRITE version.txt ${OBS_VERSION_SHA})
		if(OBS_VERSION_MAJOR EQUAL OBS_VERSION_SHA)
			set(OBS_VERSION "${OBS_VERSION_MAJOR}")
		else()
